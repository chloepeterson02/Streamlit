...
text_passage = '<p style="font-family:Courier; color:red; font-size: 20px;">This website depicts data for the tallest 100 skyscrapers in the world. There is a 3D map above. Below there is a scatter plot that compares height to completion year, the graph below that shows the average meters until a specific year (eg. if you choose year 200, year 2000 will display the average height that all the skyscrappers acheived until 200 not just in 2000, and finally there is a pie chart comparing the functions of the skyscrappers. </p>'

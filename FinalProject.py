...
def scatterplot():
    ...
    for row in skyscrapers_data:
        ...
        plt.title("Height Compared to Completion Year", fontsize=13)
...
def average_height_line_chart(select_year):
    ...
    plt.title("Average Height compared to completion year", fontsize=13)
...
def main():
    ...
    text_passage = '<p style="font-family:Courier; color:red; font-size: 20px;">This website depicts data for the tallest 100 skyscrapers in the world. There is a 3D map below, and if you select the check boxes below, the original data frame and a second map with all 100 skyscrapers will appear. Below there is a scatter plot that compares height to completion year, the graph below that shows the average meters until a specific year (eg. if you choose year 2000, year 2000 will display the average height that all the skyscrapers achieved until 2000 not just in 2000, and finally there is a pie chart comparing the functions of the skyscrappers. </p>'
    st.markdown(text_passage, unsafe_allow_html=True)
